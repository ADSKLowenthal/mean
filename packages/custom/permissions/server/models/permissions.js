(function(){
  ...
  PermissionSchema.statics.buildPermissions = buildPermissions;
  PermissionSchema.statics.buildTrees = buildTrees;

  function buildPermissions(callback){
    var data = {
  ...
  console.log('Using Permissions Model');
